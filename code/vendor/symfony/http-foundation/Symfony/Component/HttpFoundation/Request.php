...
class Request
{
	 ...
	 */
	protected static $trustedHeaders = array(self::HEADER_CLIENT_IP    => 'X_FORWARDED_FOR',
	...
	public static function createFromGlobals()
	{
		...
		if (0 === strpos($request->headers->get('CONTENT_TYPE'), 'application/x-www-form-urlencoded') && in_array(strtoupper($request->server->get('REQUEST_METHOD', 'GET')), array('PUT',
					'DELETE',
					'PATCH'))
		) {
	...
	{
		$server = array_replace(array('SERVER_NAME'          => 'localhost',
		                              'SERVER_PORT'          => 80,
		                              'HTTP_HOST'            => 'localhost',
	...
	{
		static::$formats = array('html' => array('text/html', 'application/xhtml+xml'),
