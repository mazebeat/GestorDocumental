...
class Response
{
	 ...
	 * @var array
	 */
	public static $statusTexts = array(100 => 'Continue',
	...
	{
		if ($diff = array_diff(array_keys($options), array('etag',
				'last_modified',
				'max_age',
				's_maxage',
				'private',
	...
	{
		return in_array($this->statusCode, array(201,
				301,
				302,
				303,
				307,
				308)) && (null === $location ?: $location == $this->headers->get('Location'));
	}
