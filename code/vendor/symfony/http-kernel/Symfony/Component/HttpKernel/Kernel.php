...
abstract class Kernel implements KernelInterface, TerminableInterface
{
	...
	protected function getKernelParameters()
	{
		...
		return array_merge(array('kernel.root_dir'        => $this->rootDir,
		                         ...
		                         'kernel.container_class' => $this->getContainerClass(),), $this->getEnvParameters());
	}
	...
	protected function getContainerLoader(ContainerInterface $container)
	{
		...
		$resolver = new LoaderResolver(array(new XmlFileLoader($container, $locator),
