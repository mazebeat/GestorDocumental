...
class MongoDbProfilerStorage implements ProfilerStorageInterface
{
	...
	{
		$cursor = $this->getMongo()->find($this->buildQuery($ip, $url, $method, $start, $end), array('_id',
				'parent',
				'ip',
				'method',
				'url',
				'time'))->sort(array('time' => -1))->limit($limit);
	...
	public function write(Profile $profile)
	{
		...
		$record = array('_id'    => $profile->getToken(),
