...
class HttpCache implements HttpKernelInterface, TerminableInterface
{
	 ...
	 *                            public or private via a Cache-Control directive. (default: Authorization and
	 *                            Cookie)
	 *
	 ...
	 *
	 *   * stale_if_error         Specifies the default number of seconds (the granularity is the second) during
	 *   which the cache can serve a stale response when an error is encountered (default: 60). This setting is
	 *   overridden by the stale-if-error HTTP Cache-Control extension
	 *                            (see RFC 5861).
	 *
	...
	public function __construct(HttpKernelInterface $kernel, StoreInterface $store, Esi $esi = null, array $options = array())
	{
		...
		$this->options = array_merge(array('debug'                  => false,
		                                   'default_ttl'            => 0,
