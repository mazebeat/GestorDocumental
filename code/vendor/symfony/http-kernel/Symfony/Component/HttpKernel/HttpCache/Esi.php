...
class Esi
{
	 ...
	 */
	public function __construct(array $contentTypes = array('text/html',
			'text/xml',
	...
	public function process(Request $request, Response $response)
	{
		...
		$content = preg_replace_callback('#<esi\:include\s+(.*?)\s*(?:/|</esi\:include)>#', array($this,
				'handleEsiIncludeTag'), $content);
