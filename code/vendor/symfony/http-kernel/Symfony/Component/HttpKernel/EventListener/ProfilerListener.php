...
class ProfilerListener implements EventSubscriberInterface
{
	 ...
	 * @param bool                         $onlyMasterRequests true if the profiler only collects data when the
	 *                                                         request is a master request, false otherwise
	...
	{
		return array(// kernel.request must be registered as early as possible to not break
