...
class Process
{
	 ...
	 * @var array
	 */
	public static $exitCodes = array(0   => 'OK',
	                                 1   => 'General error',
	 ...
	 * @param int       $signal  A POSIX signal to send in case the process has not stop at timeout, default is
	 *                           SIGKILL
	 *
	 ...
	 *
	 * @throws RuntimeException In case --enable-sigchild is activated and the sigchild compatibility mode is
	 *                          disabled
	 *
