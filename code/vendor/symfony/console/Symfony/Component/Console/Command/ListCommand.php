...
EOF
	...
	{
		return new InputDefinition(array(new InputArgument('namespace', InputArgument::OPTIONAL, 'The namespace name'),
	...
	protected function execute(InputInterface $input, OutputInterface $output)
	{
		...
		$helper->describe($output, $this->getApplication(), array('format'    => $input->getOption('format'),
