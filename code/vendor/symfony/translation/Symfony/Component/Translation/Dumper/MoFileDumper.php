...
class MoFileDumper extends FileDumper
{
	...
	public function format(MessageCatalogue $messages, $domain = 'messages')
	{
		...
		$header = array('magicNumber'      => MoFileLoader::MO_LITTLE_ENDIAN_MAGIC,
		                'formatRevision'   => 0,
		                'count'            => $size,
		...
		$output = implode(array_map(array($this,
						'writeLong'), $header)) . $sourceOffsets . $targetOffsets . $sources . $targets;
