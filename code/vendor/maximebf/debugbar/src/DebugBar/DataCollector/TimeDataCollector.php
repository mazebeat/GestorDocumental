...
class TimeDataCollector extends DataCollector implements Renderable
{
	...
	public function startMeasure($name, $label = null, $collector = null)
	{
		...
		$this->startedMeasures[$name] = array('label'     => $label ?: $name,
		                                      'start'     => $start,
		                                      'collector' => $collector);
	}
	...
	{
		$this->measures[] = array('label'          => $label,
		                          'start'          => $start,
	...
	public function collect()
	{
		...
		return array('start'        => $this->requestStartTime,
	...
	{
		return array("time"     => array("icon"    => "clock-o",
		                                 "tooltip" => "Request Duration",
		                                 "map"     => "time.duration_str",
		                                 "default" => "'0ms'"),
		             "timeline" => array("icon"    => "tasks",
