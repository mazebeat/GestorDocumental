...
class PropelCollector extends DataCollector implements BasicLogger, Renderable, AssetProvider
{
	...
	public static function enablePropelProfiling(PropelConfiguration $config = null)
	{
		...
		$allMethods = array('PropelPDO::__construct',       // logs connection opening
	...
	{
		$map = array(Propel::LOG_EMERG   => LogLevel::EMERGENCY,
	...
	{
		return array('nb_statements'            => count($this->statements),
	...
	{
		return array("propel"       => array("icon"    => "bolt",
		                                     "widget"  => "PhpDebugBar.Widgets.SQLQueriesWidget",
		                                     "map"     => "propel",
		                                     "default" => "[]"),
		             "propel:badge" => array("map"     => "propel.nb_statements",
		                                     "default" => 0));
	}

	public function getAssets()
	{
		return array('css' => 'widgets/sqlqueries/widget.css',
