...
class JavascriptRenderer
{
	...
	protected $jsVendors = array('vendor/jquery/dist/jquery.min.js',
	...
	{
		$this->additionalAssets[] = array('base_path' => $basePath,
		                                  'base_url'  => $baseUrl,
		                                  'css'       => (array)$cssFiles,
		                                  'js'        => (array)$jsFiles);
	...
	public function getAsseticCollection($type = null)
	{
		...
		return $this->filterAssetArray(array($this->createAsseticCollection($cssFiles),
			$this->createAsseticCollection($jsFiles)), $type);
	}
