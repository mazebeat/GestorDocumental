...
class PdoStorage implements StorageInterface
{
	...
	protected $sqlQueries = array('save'  => "INSERT INTO %tablename% (id, data, meta_utime, meta_datetime, meta_uri, meta_ip, meta_method) VALUES (?, ?, ?, ?, ?, ?, ?)",
	...
	public function find(array $filters = array(), $max = 20, $offset = 0)
	{
		...
		$sql = $this->getSqlQuery('find', array('where'  => $where,
		                                        'offset' => $offset,
		                                        'limit'  => $max));
