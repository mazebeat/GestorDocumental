...
class Swift_Signers_SMimeSigner implements Swift_Signers_BodySigner
{
	 ...
	 *
	 * @param string|array $recipientCerts Either an single X.509 certificate, or an assoc array of X.509
	 *                                     certificates.
	 * @param int          $cipher
	 *
	 ...
	 *
	 * @param string       $certificate
	 * @param string|array $privateKey  If the key needs an passphrase use array('file-location', 'passphrase')
	 *                                  instead
	 ...
	 * As this goes against the official specs, its recommended to only use 'encryption -> signing' when
	 * specifically targeting these 'broken' clients.
	 *
