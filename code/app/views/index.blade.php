...
<div ng-controller="signInController">
    ...
    {{-- Password input --}}
    <div class="control-group" ng-class="{ 'has-error': loginForm.password.$invalid, 'has-success' : !loginForm.password.$invalid }">
    ...
    <div class="modal fade" id="profileList" tabindex="-1" role="dialog" aria-labelledby="profilList" aria-hidden="true" ng-show="perfilesFromQuery">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Usuario correcto!</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
