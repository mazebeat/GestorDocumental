...
@section('left-side')
	<div class="signin-info">
		...
		<div class="row">
			<div class="col-md-9">
				<span class="">{{ HTML::image('images/loginLogo.png', 'Intelidata', array('class' => 'img-responsive')) }}</span>
			</div>
		</div>
	</div>
@endsection
...
@section('right-side')
	<div ng-controller="signInController">
		...
		{{-- Password input --}}
		<a href="{{ URL::to('#') }}" data-toggle="modal" data-target="#forgotPass">
			<small>Olvidaste tu contraseña?</small>
		</a>
		{{ Form::button('Iniciar Sesión', array('id' => 'loginFormButton', 'class' =>'btn btn-danger btn-block ladda-button', 'data-style' =>'expand-right', 'data-size' => 's', 'ng-disabled' => 'loginForm.$invalid',  'ng-click' => 'signInOne()')) }}
		{{-- Close form --}}
		{{ Form::close() }}
						...
						<div class="row">
							...
							<div class="col-md-9">
								...
								<div class="form-group">
									<select id="profile" name="profile" class="form-control chosen-select ng-dirty ng-invalid" required chosen disable-search="true" allow-single-deselect="true" data-placeholder="Seleccione un perfil..." no-results-text="'Usuario sin perfil asociado'" ng-model="user.profile" ng-options="p.code as p.name for p in perfilesFromQuery">
										<option value=""></option>
									</select>
								</div>
							</div>
