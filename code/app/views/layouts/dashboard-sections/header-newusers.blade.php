	...
	<div class="dropdown-menu dropdown-menu-head pull-right">
		...
		<ul class="dropdown-list user-list">
			<li class="new">
				...
				<div class="desc">
					<h5><a href="{{ URL::to('#') }}">Draniem Daamul (@draniem)</a> <span class="badge badge-success">new</span></h5>
				</div>
			</li>
			<li class="new">
				<div class="thumb"><a href="{{ URL::to('#') }}">{{ HTML::image('images/photos/user2.png') }}</a></div>
				<div class="desc">
					<h5><a href="{{ URL::to('#') }}">Zaham Sindilmaca (@zaham)</a> <span class="badge badge-success">new</span></h5>
				</div>
			</li>
			<li>
