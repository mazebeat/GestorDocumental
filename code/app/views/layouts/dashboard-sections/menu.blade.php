...
<ul class="nav nav-pills nav-stacked nav-bracket">
    ...
    {{--</ul>--}}
    {{--</li>--}}
    {{--<li class="nav-parent"><a href="{{ URL::to('#') }}"><i class="fa fa-suitcase"></i> <span>UI Elements</span></a>--}}
    {{--<ul class="children">--}}
    ...
    {{--<li class="nav-parent"><a href="{{ URL::to('#') }}"><i class="fa fa-file-text"></i> <span>Pages</span></a>--}}
    {{--<ul class="children">--}}
