				...
				<div class="panel panel-dark">
					<div class="panel-heading">
						<div class="panel-btns">
							<a href="{{ URL::to('#') }}" class="panel-close">&times;</a> <a href="{{ URL::to('#') }}" class="minimize">&minus;</a>
						</div>
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<button type="submit" id="saveBtn" class="btn btn-success pull-right ladda-button" data-size="s" ng-disabled="profileForm.$invalid"><i class="fa fa-check fa-fw"></i>Guardar
							</button>
						</div>
					</div>
				</div>
